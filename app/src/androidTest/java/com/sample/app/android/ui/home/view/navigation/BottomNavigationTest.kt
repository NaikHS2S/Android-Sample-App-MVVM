...
class BottomNavigationTest {
    ...
    @get:Rule var activityTestRule = ActivityTestRule(HomeActivity::class.java)
    ...
    fun bottomNavView_backstackMaintained() {
        ...
        onView(withContentDescription(R.string.update))
                .perform(click())
    ...
    private fun assertSecondScreen() {
        onView(allOf(withText(R.string.employee_fragment), isDescendantOfA(withId(R.id.action_bar))))
                .check(matches(isDisplayed()))
    }

    private fun openSecondScreen() {
        onView(allOf(withContentDescription(R.string.employee_fragment), isDisplayed()))
                .perform(click())
    }
    ...
    private fun openThirdScreen() {
        onView(allOf(withContentDescription(R.string.update_name), isDisplayed()))
                .perform(click())
    }

    private fun assertThirdScreen() {
        onView(withText(R.string.select_a_profile_image))
                .check(matches(isDisplayed()))
    }
}
