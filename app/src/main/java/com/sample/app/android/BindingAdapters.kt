...
@BindingAdapter("app:userNameError")
...
@BindingAdapter("app:loginEnable")
fun loginEnable(view: Button, isLoginEnable: Boolean) {
    view.isEnabled = isLoginEnable
}

@BindingAdapter(value = ["app:accessibilityReadText", "app:isClickable"], requireAll = false)
